...
<head>
    ...
    <title>Kicks Stock Sign in page</title>
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome, kicksadmin!</h1>
                                    </div>
                                    @if ($errors->any())
                                    ...
                                    <form class="form-login user" method="POST" action="/login">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user password"
                                                id="exampleInputPassword" placeholder="Also The Password" name="password">
                                                @error('password')
                                                    <small class="text-danger">
                                                        {{ $message }}
                                                    </small>
