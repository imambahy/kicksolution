...
<div class="flex py-10 md:py-20 px-5 md:px-32 bg-gray-200 min-h-screen">
    <div class="flex shadow w-full flex-col-reverse lg:flex-row">
        <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
            ...
            <p class="text-gray-600">Please login to start tracking your shoe!</p>
            ...
            <form action="/login_member_action" class="mt-10" method="POST">
                @csrf
                <div class="my-3">
            ...
            <span>Do not have an account? <a href="register_member" class="text-blue-400 hover:text-blue-600">Create here.</a></span>
        </div>
        <div class="w-full lg:w-1/2 bg-gray-400 flex justify-center items-center">
            <img src="/assets/shoe.png" alt="Login Image" class="w-full">
        </div>
    </div>
</div>
